...
const BANNER_CONFIG = {
  ...
  // ── Pon active: true para activar el slider de banners
  active: true,

  // Banners publicitarios dinámicos ubicados en /banners/
  // Formato recomendado: 1920 x 600 px (relación ~3.2:1). Soporta WebP, JPG, PNG y SVG.
  slides: [
    {
      id: 'banner-01',
      image: 'banners/banner-01.svg',
      title: 'Tecnología de Alto Rendimiento',
      subtitle: 'Laptops, PCs y Componentes con asesoría personalizada 100% gratuita',
      link: '#catalogo'
    },
    {
      id: 'banner-02',
      ...
      subtitle: 'No venimos a venderte. Venimos a ayudarte a elegir',
      link: '#catalogo'
    }
  ],

  // Tiempo de rotación en milisegundos entre banners
